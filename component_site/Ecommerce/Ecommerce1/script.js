const templateFile = await fetch("component_site/Ecommerce/Ecommerce1/template.html");
const template = await templateFile.text();

const templateDivFile = await fetch("component_site/Ecommerce/Ecommerce1/template-div.html");
