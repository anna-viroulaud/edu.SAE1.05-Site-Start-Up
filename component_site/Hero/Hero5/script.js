const templateFile = await fetch("component_site/Hero/Hero5/template.html");
const template = await templateFile.text();

const templateFile2 = await fetch("component_site/Hero/Hero5/template-li.html");
const templateLi = await templateFile2.text();

const templateFile3 = await fetch("component_site/Hero/Hero5/template-button.html");
