let Hero5Data = [
  {
    ...
    cards: [
      { label: '<input class="hero__5-email" placeholder="Your name" />'  },
      { label: '<input class="hero__5-email" placeholder="Your email" />'},
      { label: '<button class="hero__5-nav__9-buton">Get Started</button>' },
    ],
