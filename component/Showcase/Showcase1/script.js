const templateFile = await fetch("component/Showcase/Showcase1/template.html");
const template = await templateFile.text();
console.log("Template principal :", template); // Vérifie le contenu

const templateFile2 = await fetch("component/Showcase/Showcase1/template-div.html");
