const templateFile = await fetch("component/Navigation/Navigation14/template.html");
const template = await templateFile.text();

const templateFile2 = await fetch("component/Navigation/Navigation14/template-li.html");
